...
public class Successes {
    public final static String REVIEW_ADDED_SUCCESSFULLY = "Review added successfully.";
    public final static String TABLE_ADDED_SUCCESSFULLY = "Table added successfully";
